...
Vielleicht ist euch im Statistik Kontext schonmal der Begriff p-Wert über den Weg gelaufen. Wenn dieser klein ausfällt (typischerweise <5%), wird in der klassischen Statistik die Nullhypothese abgelehnt. Eine Aussage über die Wahrscheinlichkeit der Nullhypothese oder der Alternativhypothese ist allerdings nicht möglich.[^pWert]
