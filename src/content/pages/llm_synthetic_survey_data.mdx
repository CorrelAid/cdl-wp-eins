...
<Citation key="MH35S3ET" mode="narrative" /> created ASPIRE (Automated Synthetic Persona Interview and Response Engine) (Couldn’t find their python code though).
...
<Citation key="PYJJ3X5U" mode="parenthetical" />
