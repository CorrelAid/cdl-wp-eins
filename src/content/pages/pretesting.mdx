...
- **Stark bei**: Verständnisproblemen, Mehrdeutigkeiten, unklaren Antwortoptionen, ungewohnten Frageformaten (→ [Antworttypen](/antworttypen)), Akzeptanz und unbewussten Schwierigkeiten.
...
Auch das Feedback von ein, zwei Kolleg\*innen findet zuverlässig Tippfehler, ungeeignete Fragen (→ [Fragen formulieren](/gute-fragen-schreiben)) und technische Probleme wie kaputte Mobile-Darstellung oder lange Ladezeiten.
