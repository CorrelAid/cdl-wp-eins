...
Wir haben für euch Tutorials zur Bayesschen Statistik zusammengestellt. Für Nicht-Coder empfehlen wir die Arbeit mit dem Programm [JASP](jasp). In der [Testauswahl](testauswahl) gibt es außerdem Hilfestellung, welcher Test zu welcher Forschungsfrage passt. Wer tiefer in die Bayessche Statistik einsteigen möchte und Coding-Erfahrung hat, findet in unserem GitHub Repository [survey-bayes](https://github.com/CorrelAid/survey-bayes) eine vertiefte Anleitung.
