--- 
tocTitle: XLSForm - Brief Overview
teaser: A concise introduction to XLSForm with examples
--- 

import SpreadsheetWithTabs from '../../components/SpreadsheetWithTabs.svelte';

# XLSForm - Brief Overview
...
<SpreadsheetWithTabs client:load worksheets={[
  {
    id: 'survey',
