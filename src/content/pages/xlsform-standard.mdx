...
<XlsFormDisplay worksheets={[
  {
    ...
    data: [
      ...
      ['geopoint', 'store_gps', 'Erfasse die GPS-Koordinaten dieses Geschäfts.']
    ]
  }
]} />
...
<XlsFormDisplay worksheets={[
  {
    id: 'choices',
    title: 'Auswahl',
    headers: ['list_name', 'name', 'label', 'Geometrie'],
    data: [
...
<XlsFormDisplay worksheets={[
  {
    ...
    headers: ['type', 'name', 'label', 'parameters'],
    data: [
      ['image', 'image', 'Bild hochladen', 'max-pixels=1000']
    ]
  }
]} />
...
<XlsFormDisplay worksheets={[
  {
    ...
    data: [
      ['xml-extern', 'Häuser', '', ''],
      ['integer', 'Zimmer', 'Wie viele Zimmer?', ''],
      ['calculate', 'Zählen', '', "count(instance('Häuser')/Haus[Zimmer = current()/../Zimmer ])"]
    ]
  }
]} /> */}
...
<XlsFormDisplay worksheets={[
  {
    ...
    data: [
      ['select_one ja_nein', 'mag_Pizza', 'Magst du Pizza?', ''],
      ['select_multiple Pizzabeläge oder_anderes', 'Lieblingsbelag', 'Lieblingsbelag', "${likes_pizza} = 'ja'"]
    ]
  }
]} />
...
<XlsFormDisplay worksheets={[
  {
    ...
    data: [
      ...
      ['note', 'Anzeigen', '18 % Trinkgeld für Ihre Mahlzeit beträgt: ${tip}', '']
    ]
  }
]} />
...
<XlsFormDisplay worksheets={[
  {
    ...
    data: [
      ...
      ['note', 'Anzeige', '18 % Trinkgeld für Ihre Mahlzeit beträgt: ${tip}', '', '']
    ]
  }
]} />
...
<XlsFormDisplay worksheets={[
  {
    ...
    data: [
      ['decimal', 'Betrag', 'Wie viel hat das Essen gekostet?', '', ''],
      ['note', 'Anzeige', '18 % Trinkgeld für Ihr Essen betragen:', '', '${Betrag} * 0,18'],
...
<XlsFormDisplay worksheets={[
  {
    id: 'survey',
    title: 'survey',
    headers: ['type', 'name', 'label', 'calculation', 'trigger'],
    data: [
      ['integer', 'Temp', 'Geben Sie die aktuelle Temperatur ein', '', ''],
...
<XlsFormDisplay worksheets={[
  {
    id: 'survey',
    title: 'survey',
    headers: ['type', 'name', 'label', 'calculation', 'Auslöser', 'schreibgeschützt'],
    data: [
...
<XlsFormDisplay worksheets={[
  {
    ...
    data: [
      ...
      ['integer', 'Alter', 'Wie alt ist diese Person?', '', 'S{name}']
    ]
  }
]} />
...
<XlsFormDisplay worksheets={[
  {
    id: 'survey',
    title: 'survey',
    headers: ['type', 'parameters', 'name', 'label'],
    data: [
...
<XlsFormDisplay worksheets={[
  {
    id: 'survey',
    title: 'survey',
    headers: ['type', 'parameters', 'name', 'label', 'calculation'],
    data: [
      ['calculate', '', 'sd', '', 'einmal(decimal-date-time(now()))'],
...
<XlsFormDisplay worksheets={[
  {
    ...
    headers: ['type', 'name', 'label'],
    data: [
      ['begin_repeat', 'person_repeat', ''],
      ['begin_group', 'Person', '${Vorname} ${Nachname} - ${Alter}'],
...
<XlsFormDisplay worksheets={[
  {
    id: 'survey',
    title: 'survey',
    headers: ['type', 'name', 'label', 'repeat_count'],
    data: [
...
<XlsFormDisplay worksheets={[
  {
    id: 'survey',
    title: 'survey',
    headers: ['type', 'name', 'label', 'Wiederholungsanzahl'],
    data: [
      ['integer', 'Anzahl_Haushaltsmitglieder', 'Anzahl der Haushaltsmitglieder?', ''],
      ['begin_repeat', 'hh_member', '', '${num_hh_members}'],
      ['text', 'name', 'name', ''],
      ['integer', 'Alter', 'Alter', ''],
      ['end_repeat', '', '', '']
    ]
...
<XlsFormDisplay worksheets={[
  {
    ...
    data: [
      ...
      ["begin_repeat", 'child_repeat', '', "${has_child} = 'ja'"],
      ['text', 'name', 'Name des Kindes', ''],
      ['decimal', 'Geburtsgewicht', 'Geburtsgewicht des Kindes', ''],
      ['end_repeat', '', '', '']
    ]
...
<XlsFormDisplay worksheets={[
  {
    id: 'survey',
    title: 'survey',
    headers: ['type', 'name', 'label', 'image', 'video'],
    data: [
      ['note', 'Medienbeispiel', 'Medienbeispiel', 'Beispiel.jpg', 'Beispiel.mp4']
    ]
  }
]} />
...
<XlsFormDisplay worksheets={[
  {
    id: 'survey',
    title: 'survey',
    headers: ['type', 'name', 'label', 'read_only', 'default'],
    data: [
      ['integer', 'num', 'Bitte geben Sie die Patientennummer ein:', 'ja', '5']
    ]
  }
]} /> */}
...
Sehen Sie sich [dieses Beispiel für eine XLSForm](https://docs.google.com/a/ona.io/spreadsheets/d/1Bapi05GYITV6D0THvs9RaOSEjqb1-FWIhfjSTXtvl8I/edit#gid=1932003628) an, das den Instanznamen als Zusammensetzung aus dem Vor- und Nachnamen des Benutzers und der UUID der Formularübermittlung berechnet.
...
<XlsFormDisplay worksheets={[
  ...
  },
  {
    id: 'survey',
    title: 'survey',
    headers: ['type', 'name', 'label', 'bind::esri:fieldLength', 'bind::enk:for'],
    data: [
...
<XlsFormDisplay worksheets={[
  {
    ...
    data: [
      ...
      ['note', 'note_fruit', 'Die Frucht ${fruit} wurde aus der CSV-Datei abgerufen.', '']
    ]
  }
]} />
