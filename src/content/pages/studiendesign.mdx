---
pageTitle: Studiendesign & Umfragetypen
...
**Zum Abschluss**: Studiendesign ist eine Dimension der [Belastbarkeit](/handeln-einleitung#wie-belastbar-sind-eure-daten) eurer Erkenntnisse. Je nach Design könnt ihr unterschiedliche Arten von Aussagen treffen (vgl. auch <Citation key="LJB9BV5W" mode="na" page="8-9"/>):
