...
- [Datenschutzinformation für offen personenbezogene Daten](https://civic-data.de/app/uploads/DSGVO_Info_Vorlage_offen-personenbezogen.docx)
- [Datenschutzinformation für pseudonomysierte Umfragen](https://civic-data.de/app/uploads/DSGVO-Info_Vorlage_pseudonomysiert.docx)
- [Datenschutzinformation für getrennt erhobene personenbezogene Daten](https://civic-data.de/app/uploads/DSGVO_Info_getrennt-erhoben.docx)
- [Transparenzinformation (freiwillig) bei wirklich anonymen Umfragen](https://civic-data.de/app/uploads/DSGVO_Info_Vorlage_anonym.docx)
